# Operator Quickstart — Building of Ships and Floating Structures

Shortest path from clone to a verified local dry-run for **ISIC 3011** (`cloud-itonami-isic-3011`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3011.git
cd cloud-itonami-isic-3011
```
...
- Blueprint governor key: `shipyard-governor`
- Likely source path: `shipyard.governor.cljc`
